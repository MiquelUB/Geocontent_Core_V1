                    ...
                    <div className="p-4">
                      <div className="flex flex-wrap gap-4 mb-4 text-[10px] text-stone-500">
                        ...
                        <div className="flex items-center gap-1">
                          <Badge variant="outline" className={`text-[9px] ${poi.visitor_potential === 'alt' ? `${activeTheme.border} ${activeTheme.text}` : poi.visitor_potential === 'mitjà' ? 'border-orange-200 text-orange-700' : 'border-stone-200 text-stone-500'}`}>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {result.route_building_notes.top_pois && (
                    <div className={`${activeTheme.bg} p-4 rounded-lg border ${activeTheme.border}`}>
                      <h5 className={`text-[11px] font-bold ${activeTheme.mainText} uppercase mb-3`}>⭐ Punts Clau (Top 3)</h5>
                      <ul className="space-y-2">
                        {result.route_building_notes.top_pois.map((note: any, i: number) => (
                          <li key={i} className={`text-xs ${activeTheme.text} leading-snug`}>
