...
# Afegeix el directori arrel de backend-python al path per poder importar models
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
from models import SQLModel  # Assegura que models/__init__.py importa tots els models
...
# target_metadata apunta al registre base de SQLModel
